...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "FORNECEDOR GAS DE COZINHA",
            "utilities",
        ),
        (
            "FORNECEDOR GÁS DE COZINHA",
            "utilities",
        ),
        (
            "TEST PHARMACY",
...
def test_categorization_preserves_transaction_data():
    ...
    assert (
        categorized.original_description
