        ...
        return [
            {
                ...
                "arguments": list(tool.argument_names),
            }
...
DEFAULT_TOOLS = {
    "get_monthly_spending": RegisteredTool(
        ...
        "Return total expense spending for one calendar month.",
        ToolPermission.READ,
        run_monthly_spending,
        ("year", "month"),
    ),
    "get_category_spending": RegisteredTool(
        ...
        "Return expense spending grouped by category for one calendar month.",
        ToolPermission.READ,
        run_category_spending,
        ("year", "month"),
    ),
    "compare_monthly_spending": RegisteredTool(
        ...
        run_spending_comparison,
        ("base_year", "base_month", "comparison_year", "comparison_month"),
    ),
    "find_recurring_expenses": RegisteredTool(
        "find_recurring_expenses",
        "Find deterministic recurring expense candidates in a date range.",
        ToolPermission.ANALYZE,
        run_recurring_expenses,
        (
    ...
    "get_cash_flow": RegisteredTool(
        "get_cash_flow",
        "Return deterministic income, expense, transfer, and net cash-flow totals.",
        ToolPermission.ANALYZE,
        run_cash_flow,
        ("start_date", "end_date"),
    ),
    "detect_spending_anomalies": RegisteredTool(
        ...
        "Find deterministic spending anomalies using prior merchant/category history.",
        ToolPermission.ANALYZE,
        run_spending_anomalies,
        ("start_date", "end_date", "min_history", "threshold_multiplier"),
    ),
}
